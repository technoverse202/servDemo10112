...
import com.rb.sss.service.ServDemo106Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo106Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo106Controller.class);
	@Inject
	ServDemo106Service service;
